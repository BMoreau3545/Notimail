...
async function login (req, res) {
    try {
        ...
        //Dans ce cas, on cherche un utilisateur dont la valeur dans la colonne 'firm_name' de la base de données correspond à la variable 'firm_name' récupéré dans la requete.
        console.log(user)
